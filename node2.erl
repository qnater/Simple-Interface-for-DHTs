...
-export([launch/1, deploy/1, deploy/3, connect/2, notify/4, request/2, stabilize/3, handle_node/1, node/4, create_probe/3, remove_probe/2, forward_probe/6, handover/3, add/8, lookup/7,addEntry/4, getEntry/2, getEntry/3]).
